...
export class TaskListComponent implements AfterViewInit, OnChanges {
  ...
  displayedColumns: string[] = ['important', 'location', 'subject', 'creationDate', 'status', 'forwardedTo'];
  ...
  getLadenEnumValue(key: keyof typeof StoreEnum): string {
    return StoreEnum[key];
  }
}
